...
1. `rust` and the `wasm32-unknown-unknown` target. See https://soroban.stellar.org/docs/getting-started/setup#install-rust. Be sure to install `rustc` version `1.70` or newer
...
6. If you want to run everything locally, build the `soroban-preview` docker image:
